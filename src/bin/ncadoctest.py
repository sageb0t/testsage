...
def testmod(m=None, name=None, globs=None, verbose=None,
            report=True, optionflags=0, extraglobs=None,
            raise_on_error=False, exclude_empty=False, runner=None):

    runner = testmod_returning_runner(m=m, name=name, globs=globs, verbose=verbose,
                                      report=report, optionflags=optionflags, extraglobs=extraglobs,
                                      raise_on_error=raise_on_error, exclude_empty=exclude_empty, runner=runner)
