...
cdef class GenericBackend:
    ...
    cpdef int add_variable(self):
        ...
        EXAMPLE::
            ...
            sage: p = getSolver(solver = "Nonexistent_LP_solver")    # optional - Nonexistent_LP_solver
            sage: p.n_cols()                                         # optional - Nonexistent_LP_solver
            0
    ...
    cpdef set_direction(self, int sense):
        ...
        EXAMPLE::
            ...
            True
            sage: p.set_direction(-1)                              # optional - Nonexistent_LP_solver
            sage: p.is_maximization()                              # optional - Nonexistent_LP_solver
            False
        """
    ...
    cpdef  set_objective_coeff(self, int variable, double coeff):
        ...
        EXAMPLE::
            ...
            0.0
            sage: p.set_objective_coeff(0,2)                       # optional - Nonexistent_LP_solver
            sage: p.get_objective_coeff(0)                         # optional - Nonexistent_LP_solver
            2.0
        """
    ...
    cpdef set_log_level(self, int level):
        ...
        EXAMPLE::
            ...
            sage: from sage.numerical.backends.generic_backend import getSolver
            sage: p = getSolver(solver = "Nonexistent_LP_solver")   # optional - Nonexistent_LP_solver
            sage: p.set_log_level(2)                                # optional - Nonexistent_LP_solver
    ...
    cpdef add_constraint(self, list indices, list coeffs, int direction, double bound):
        ...
        EXAMPLE::
            ...
            sage: p.get_row(0)                                    # optional - Nonexistent_LP_solver
            ([4, 3, 2, 1], [4.0, 3.0, 2.0, 1.0])
            sage: p.get_row_bounds(0)                             # optional - Nonexistent_LP_solver
            (2.0, 2.0)
        """
        raise NotImplementedError()
    ...
    cpdef add_col(self, list indices, list coeffs):
        ...
        EXAMPLE::
            ...
            sage: p.n_cols()                                       # optional - Nonexistent_LP_solver
            0
            sage: p.n_rows()                                       # optional - Nonexistent_LP_solver
            0
    ...
    cpdef add_constraints(self, int number, int direction, double bound):
        ...
        EXAMPLE::
            ...
            sage: p.get_row(4)                                      # optional - Nonexistent_LP_solver
            ([], [])
            sage: p.get_row_bounds(4)                               # optional - Nonexistent_LP_solver
            (None, 2.0)
        """
    ...
    cpdef int solve(self) except -1:
        ...
        EXAMPLE::
            ...
            0
            sage: p.set_objective_coeff(0,1)                      # optional - Nonexistent_LP_solver
            sage: p.solve()                                       # optional - Nonexistent_LP_solver
    ...
    cpdef  set_problem_name(self, char * name):
        ...
        EXAMPLE::
            ...
            sage: from sage.numerical.backends.generic_backend import getSolver
            sage: p = getSolver(solver = "Nonexistent_LP_solver")   # optional - Nonexistent_LP_solver
            sage: p.set_problem_name("There once was a french fry") # optional - Nonexistent_LP_solver
    ...
    cpdef get_row_name(self, int index):
        ...
        EXAMPLE::
            ...
            sage: p.add_variable()                                 # optional - Nonexistent_LP_solver
            1
            sage: p.set_col_name(0, "I am a variable")             # optional - Nonexistent_LP_solver
            sage: p.get_col_name(0)                                # optional - Nonexistent_LP_solver
            'I am a variable'
        """
    ...
    cpdef get_col_bounds(self, int index):
        ...
        EXAMPLE::
            ...
            sage: p.add_variable()                                 # optional - Nonexistent_LP_solver
            1
            sage: p.get_col_bounds(0)                              # optional - Nonexistent_LP_solver
            (0.0, None)
            sage: p.set_variable_max(0, 5)                         # optional - Nonexistent_LP_solver
            sage: p.get_col_bounds(0)                              # optional - Nonexistent_LP_solver
            (0.0, 5.0)
        """
    ...
    cpdef set_row_name(self, int index, char * name):
        ...
        EXAMPLE::
            ...
            sage: p.set_row_name(0, "Empty constraint 1")          # optional - Nonexistent_LP_solver
            sage: p.get_row_name(0)                                # optional - Nonexistent_LP_solver
            'Empty constraint 1'
    ...
    cpdef get_variable_max(self, int index):
        ...
        EXAMPLE::
            ...
            sage: p.add_variable()                                 # optional - Nonexistent_LP_solver
            1
            sage: p.get_variable_max(0) is None                    # optional - Nonexistent_LP_solver
            True
            sage: p.set_variable_max(0, 5)                         # optional - Nonexistent_LP_solver
            sage: p.get_variable_max(0)                            # optional - Nonexistent_LP_solver
            5.0
    ...
    cpdef get_variable_min(self, int index):
        ...
        EXAMPLE::
            ...
            sage: p.add_variable()                                 # optional - Nonexistent_LP_solver
            1
            sage: p.get_variable_min(0)                            # optional - Nonexistent_LP_solver
            0.0
            sage: p.set_variable_min(0, 5)                         # optional - Nonexistent_LP_solver
            sage: p.get_variable_min(0)                            # optional - Nonexistent_LP_solver
            5.0
        """
        raise NotImplementedError()
...
cpdef GenericBackend getSolver(constraint_generation = False, solver = None):
    r"""
