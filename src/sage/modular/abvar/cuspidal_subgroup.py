...
We compute the cuspidal subgroup of $J_1(13)$:
    ...
    Cuspidal subgroup of Jacobian of the modular curve associated to the congruence subgroup Gamma1(13)
    sage: C.gens()
...
We compute the cuspidal subgroup of $J_0(54)$:
    sage: A = J0(54)
    sage: C = A.cuspidal_subgroup(); C
    Cuspidal subgroup of Jacobian of the modular curve associated to the congruence subgroup Gamma0(54)
    sage: C.gens()
