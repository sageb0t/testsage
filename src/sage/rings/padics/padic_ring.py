...
class pAdicRingGeneric(sage.rings.ring.CommutativeRing):
...
class pAdicRing(pAdicRingGeneric): #, ring.DiscreteValuationRing):
    ...
    def __init__(self, p, series_print = True, print_prec = infinity):
        self._p = p
        self._series_print = series_print
        self._print_prec = print_prec
...
class pAdicRingFixedMod(pAdicRingGeneric, sage.rings.ring.NoetherianRing):
    r"""
