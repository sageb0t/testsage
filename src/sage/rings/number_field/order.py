...
We compute a basis for a relative order generated by 2 elements:
    ...
    def is_maximal(self):
        ...
        Returns True if this is the maximal order.
         ...
         An example involving a relative order:
            ...
            Relative Order with ZZ-module basis 1, 3*a + -b, (-3*b)*a + 3, 3*a in Number Field in a with defining polynomial x^2 + 1 over its base field
            sage: O.is_maximal()
            False
