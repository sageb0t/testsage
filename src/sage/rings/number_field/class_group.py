...
class FractionalIdealClass(MultiplicativeGroupElement):
    ...
    EXAMPLES:
        ...
        sage: I*I
        Fractional ideal class (4, 1/2*a + 3/2) of Number Field in a with defining polynomial x^2 + 23
        sage: I*I*I
    ...
    def reduce(self):
        ...
        EXAMPLES:
            ...
            IClass group of order 76 with structure C38 x C2 of Number Field in a with defining polynomial x^2 + 20072
            sage: I = G.0; I
    ...
    def ideal(self):
        """
        Return an ideal in this ideal class.
        """
        return self.__ideal
