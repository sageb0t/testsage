...
#            25
    ...
    def padic_height_pairing_matrix(self, p, prec=20, height=None, check_hypotheses=True):
        ...
        An anomalous rank 3 example:
            ...
            [4*5^-1 + 2 + 4*5 + O(5^2)              4*5 + O(5^2)       4*5^-1 + 1 + O(5^2)]    # 32-bit
            [             4*5 + O(5^2) 4*5^-1 + 3 + 4*5 + O(5^2)       2*5^-1 + 5 + O(5^2)]    # 32-bit
            [      4*5^-1 + 1 + O(5^2)       2*5^-1 + 5 + O(5^2)              2*5 + O(5^2)]    # 32-bit
            [4*5^-1 + 3 + 4*5 + O(5^2)     4*5^-1 + 4*5 + O(5^2)          3 + 4*5 + O(5^2)]    # 64-bit
            [    4*5^-1 + 4*5 + O(5^2) 3*5^-1 + 4 + 3*5 + O(5^2)       2*5^-1 + 4 + O(5^2)]    # 64-bit
            [         3 + 4*5 + O(5^2)       2*5^-1 + 4 + O(5^2)     5^-1 + 3 + 5 + O(5^2)]    # 64-bit
