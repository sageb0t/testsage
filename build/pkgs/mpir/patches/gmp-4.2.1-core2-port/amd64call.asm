...
PROLOGUE(calling_conventions)
	movq	(%rsp), %rax
	movq	%rax, G(calling_conventions_retaddr)(%rip)

	leaq	L(return)(%rip), %rax
	movq	%rax,(%rsp)

	movq	%rbx, G(calling_conventions_save_rbx)(%rip)
	movq	%rbp, G(calling_conventions_save_rbp)(%rip)
	movq	%r12, G(calling_conventions_save_r12)(%rip)
	movq	%r13, G(calling_conventions_save_r13)(%rip)
	movq	%r14, G(calling_conventions_save_r14)(%rip)
	movq	%r15, G(calling_conventions_save_r15)(%rip)

	movq	G(calling_conventions_save_rbx)(%rip), %rbx
	movq	G(calling_conventions_save_rbp)(%rip), %rbp
	movq	G(calling_conventions_save_r12)(%rip), %r12
	movq	G(calling_conventions_save_r13)(%rip), %r13
	movq	G(calling_conventions_save_r14)(%rip), %r14
	movq	G(calling_conventions_save_r15)(%rip), %r15
	...
	jmpq	*G(calling_conventions_function)(%rip)

L(return):
	movq	%rbx, G(calling_conventions_rbx)(%rip)
	movq	%rbp, G(calling_conventions_rbp)(%rip)
	movq	%r12, G(calling_conventions_r12)(%rip)
	movq	%r13, G(calling_conventions_r13)(%rip)
	movq	%r14, G(calling_conventions_r14)(%rip)
	movq	%r15, G(calling_conventions_r15)(%rip)

	pushfq
	popq	%rbx
	movq	%rbx, G(calling_conventions_rflags)(%rip)

	fstenv	G(calling_conventions_fenv)(%rip)
	finit
	...
	jmpq	*G(calling_conventions_retaddr)(%rip)
