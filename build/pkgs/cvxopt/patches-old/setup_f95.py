...
if os.uname()[0]=="Darwin":
    libraries = ['m','lapack','blas','f95']
else:
    libraries = ['m','lapack','cblas','f77blas','atlas','f95']

#if os.path.exists(ATLAS_LIB_DIR+'/libatlas.a') or os.path.exists(ATLAS_LIB_DIR+'/libatlas.dylib') or os.path.exists(ATLAS_LIB_DIR+'/libatlas.so'):
#    libraries=['m','lapack','cblas','f77blas','atlas','f95']
#else:
#    libraries = ['m','lapack','blas','f95']
